    ...
    <ul class="navbar-nav align-items-start">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <div class="custom_title">
                <p class="mb-0">Business Promotion Council</p>
                <small class="mb-0 text-maroon"
                    >Management Information System</small
                >
            </div>
        </li>
    </ul>
        ...
        <li class="nav-item dropdown user-menu">
            ...
            >
                <div class="d-flex flex-column align-items-center pr-2">
                    <span
                        class="custom_font_size_sm d-none d-md-inline"
                        >{{ auth()->user()->name }}</span
                    >
                    <small
                        class="custom_font_size_xs align-self-end"

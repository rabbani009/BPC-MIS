<section class="content">
    <div class="card">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="_custom_actions">
                            <div class="card text-center p-1">
                                ...
                                <a
                                    ...
                                    href="#trainee{{$loop->iteration}}details"
                                    role="button"
                                    aria-expanded="false"
                                    aria-controls="trainee{{$loop->iteration}}details"
                                >
                                    More
                                </a>
                                <div
                                    class="collapse"
                                    id="trainee{{$loop->iteration}}details"
                                >
                        ...
                        <td class="custom_actions">
                            <div class="btn-group">
                                <a
                                    href="{!! route('trainee.show', $row->id) !!}"
                                ...
                                <form
                                    ...
                                    action="{!! route('trainee.destroy', $row->id) !!}"
        ...
        {{-- <!-- <div class="card-footer">
            {!!
            $get_activities_by_council->withQueryString()->links('pagination::bootstrap-5')
            !!}
        </div> --> --}}
    </div>
</section>

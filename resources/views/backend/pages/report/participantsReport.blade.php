...
<section class="content">
    ...
    <div class="card">
        ...
        <form action="{{ route('report.participants') }}" method="post" data-bitwarden-watching="1" enctype="multipart/form-data" accept-charset="UTF-8">
            @csrf
            <div class="card-body">
 ...
 @foreach($activity as $key => $row)
                ...
                <tr  @if($loop->odd) class="bg-light" @endif>
                    ...
                    <td>{{ $row->activity_title ?? 'You have deleted Activity'}}</td>
...
text: 'PDF',
extend: 'pdfHtml5',
title: 'Bangladesh Business Promotion Council participants Information',
message: '',

...
@section('content')
    <section class="content">
        ...
        <div class="card">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="post" data-bitwarden-watching="1" enctype="multipart/form-data" accept-charset="UTF-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required type="email" name="email" class="form-control @if($errors->has('email')) is-invalid @endif" value="{{  $user->email }}" placeholder="Enter email">
                                    @if($errors->has('email'))
